...
```
# Replace the path with the actual location of the PDCurses directory
nmake.exe -f .\Makefile.vc EXTRA_INCLUDES="/IC:\Users\user\src\PDCurses-3.9\" LIB_PATH="C:\Users\user\src\PDCurses-3.9\wincon\"
```
